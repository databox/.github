...
if __name__ == '__main__':
    ...
    get_public_key = requests.get('https://api.github.com/repos/databox/actions/secrets/public-key',
                                  headers={'Accept': 'application/vnd.github+json',
                                           'X-GitHub-Api-Version': '2022-11-28',
                                           'Authorization': 'token ' + os.environ['SECRETS_API_ACCESS_TOKEN']})
    ...
    update_password = requests.put('https://api.github.com/repos/databox/actions/secrets/AWS_ECR_PASSWORD',
                                   headers={'Accept': 'application/vnd.github+json',
                                           'X-GitHub-Api-Version': '2022-11-28',
                                           'Authorization': 'token ' + os.environ['SECRETS_API_ACCESS_TOKEN']},
